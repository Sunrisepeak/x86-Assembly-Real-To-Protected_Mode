...
;-------------------------------Ex02 begin-----------------------------------
      ...
      mov al, 01000010b                  ; open PIE, close other Interrupt,
      out 0x71, al                       ; and set BCD and 24h

      mov al, 0x0a                       ; setting RA of RTC
      out 0x70, al

      in al, 0x71
      and al, 0xf0
      or al, 00001110b                   ; set 250ms for PIE
      out 0x71, al
...
;-------------------------------Ex01 begin-----------------------------------
      ...
      in al, 0x21                        ; read IMR of master-8259
      or al, 0xff                        ; close all interrupt
      and al, 11111011b                  ; open IR2. because of slave-8259(link at IR2 of M-8259) of M-8259
      out 0x21, al

      in al, 0xa1                        ; read IMR of slave-8295
      or al, 0xff                        ; close all Interrupt
      and al, 11111110b                  ; open IR0 of s-8259
      out 0xa1, al
